...
searchword1 = '강아지상'
searchword2 = '얼굴'
searchurl = 'https://www.google.com/search?q=' + quote_plus(searchword1) + '+' + quote_plus(searchword2) + '+' + '&source=lnms&tbm=isch'
dirs = 'pictures'
maxcount = 1000

chromedriver = 'C:/Users/syslab/Desktop/crawling/get/selenium/chromedriver/chromedriver.exe'
